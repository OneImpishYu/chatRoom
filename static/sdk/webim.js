...
(function (webim) {
    ...
    var _login = function (loginInfo, listeners, options, cbOk, cbErr) {
        ...
        if (!loginInfo) {
            if (cbErr) {
                cbErr(tool.getReturnError("请先登录", -6));
                return;
            }
        }
    ...
    Msg.prototype.getSign = function () {
        return this.sign;
    };
    ...
    Msg.Elem.File.prototype.toHtml = function () {
        ...
        return '<a href="javascript" onclick="webim.onDownFile("' + this.uuid + '")" title="点击下载文件" ><i class="icon iconfont icon-wenjian">&nbsp;' + this.name + '(' + fileSize + unitStr + ')</i></a>';
    };
